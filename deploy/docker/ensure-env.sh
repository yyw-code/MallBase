...
ROOT_TO_BACKEND_KEYS="SWOOLE_HTTP_PORT SWOOLE_WORKER_NUM SWOOLE_QUEUE_ENABLE DB_NAME DB_USER DB_PASS SITE_URL"
ROOT_INIT_FROM_BACKEND_KEYS="SWOOLE_HTTP_PORT SWOOLE_WORKER_NUM SWOOLE_QUEUE_ENABLE DB_NAME DB_USER DB_PASS"
