...
(2, 'profile', '系统默认个人中心', '系统内置个人中心方案，不能修改或删除',
 JSON_OBJECT('modules', JSON_ARRAY(
   JSON_OBJECT('id', 'profile-user', 'type', 'userInfo', 'props', JSON_OBJECT()),
   JSON_OBJECT('id', 'profile-order', 'type', 'orderEntry', 'props', JSON_OBJECT()),
   JSON_OBJECT('id', 'profile-wallet', 'type', 'walletEntry', 'props', JSON_OBJECT()),
   JSON_OBJECT('id', 'profile-service', 'type', 'serviceMenu', 'props', JSON_OBJECT('items', JSON_ARRAY()))
 )), 'native', 1, 1, 20, 1),
