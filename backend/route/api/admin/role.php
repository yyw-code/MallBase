...
Route::group('auth/role', function () {
    Route::get('list', 'list')->name('SystemRoleList')->option(['_alias' => '列表', '_desc' => '角色列表', '_auth' => true, '_type' => Permission::TYPE_MENU]);
    Route::get('all', 'all')->name('SystemRoleAll')->option(['_alias' => '全部', '_desc' => '获取所有角色', '_auth' => true, '_type' => Permission::TYPE_MENU]);
    Route::get('info/:id', 'info')->name('SystemRoleInfo')->option(['_alias' => '详情', '_desc' => '角色详情', '_auth' => true, '_type' => Permission::TYPE_MENU]);
    ...
    Route::put('changeStatus/:id', 'changeStatus')->name('SystemRoleChangeStatus')->option(['_alias' => '更新状态', '_desc' => '更新角色状态', '_auth' => true, '_type' => Permission::TYPE_BUTTON]);
