...
Route::group('marketing/recharge-package', function () {
    Route::get('list', 'list')->name('SystemRechargePackageList')->option(['_alias' => '套餐列表', '_desc' => '获取充值套餐列表', '_auth' => true, '_type' => Permission::TYPE_MENU]);
    Route::get('info/:id', 'info')->name('SystemRechargePackageInfo')->option(['_alias' => '套餐详情', '_desc' => '获取充值套餐详情', '_auth' => true, '_type' => Permission::TYPE_MENU]);
