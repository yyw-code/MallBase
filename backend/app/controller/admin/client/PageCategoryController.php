...
use app\service\admin\client\ClientPageCategoryService;
use app\validate\admin\client\ClientPageCategoryValidate;
use mall_base\base\BaseController;

/**
 * 客户端页面分类控制器
 * @extends BaseController<ClientPageCategoryService>
 */
class PageCategoryController extends BaseController
{
    protected string $serviceClass = ClientPageCategoryService::class;
