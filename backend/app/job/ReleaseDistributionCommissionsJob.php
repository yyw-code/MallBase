...
class ReleaseDistributionCommissionsJob extends BaseJob
{
    private const LOCK_KEY = 'job:distribution:release-commissions';
    ...
    public function handle(): void
    {
        ...
        app()->make(DistributionOrderEventService::class)->releaseDueCommissions($this->limit);
    }
