...
Route::group('user/address', function () {
    Route::get('list', 'list')->name('SystemUserAddressList')->option(['_alias' => '地址列表', '_desc' => '获取用户收货地址列表', '_auth' => true]);
    Route::get('info/:id', 'info')->name('SystemUserAddressInfo')->option(['_alias' => '地址详情', '_desc' => '获取用户收货地址详情', '_auth' => true]);
