...
(105, '客服平台标识', 'customer_service_platform_code', 'mallbase', 'input', NULL, '[{"type":"required","message":"请输入平台标识"},{"type":"pattern","value":"^[a-zA-Z0-9_-]{2,40}$","message":"平台标识只能包含字母、数字、下划线和短横线"}]', 'mallbase', '写入客服上下文 token 的平台标识', 80),
(105, '上下文 Token 有效期', 'customer_service_context_ttl', '300', 'number', NULL, '[{"type":"required","message":"请填写 Token 有效期"},{"type":"integer","message":"Token 有效期必须是整数"},{"type":"min","value":60,"message":"不能小于 60 秒"},{"type":"max","value":3600,"message":"不能大于 3600 秒"}]', NULL, '单位秒，建议 300', 81),
(105, '上下文签名密钥', 'customer_service_context_secret', '', 'password', NULL, '[{"type":"min_length","value":32,"message":"上下文签名密钥至少 32 位"}]', '请输入不少于 32 位的随机密钥', '用于 MallBase 给已登录用户签发客服上下文 token', 82),
(105, '启用连接器', 'customer_service_connector_enabled', '0', 'switch', NULL, NULL, NULL, '关闭后客服系统不能调用 MallBase 连接器接口', 83),
(105, '连接器签名密钥', 'customer_service_connector_secret', '', 'password', NULL, '[{"type":"min_length","value":32,"message":"连接器签名密钥至少 32 位"}]', '请输入不少于 32 位的随机密钥', '客服系统调用 MallBase 连接器接口的 HMAC 密钥', 84),
(105, '连接器签名窗口', 'customer_service_timestamp_window', '300', 'number', NULL, '[{"type":"required","message":"请填写签名时间窗口"},{"type":"integer","message":"签名时间窗口必须是整数"},{"type":"min","value":60,"message":"不能小于 60 秒"},{"type":"max","value":3600,"message":"不能大于 3600 秒"}]', NULL, '单位秒，超过窗口的连接器请求会被拒绝', 85),
(105, '连接器允许 IP', 'customer_service_allowed_ips', '', 'input', NULL, NULL, '127.0.0.1,10.0.0.2', '留空表示不限制；多个 IP 用英文逗号分隔', 86),
(105, '连接器操作管理员 ID', 'customer_service_operator_admin_id', '1', 'number', NULL, '[{"type":"required","message":"请填写操作管理员 ID"},{"type":"integer","message":"操作管理员 ID 必须是整数"},{"type":"min","value":1,"message":"操作管理员 ID 不能小于 1"}]', NULL, '客服系统操作订单、售后时用于后台日志审计的管理员 ID', 87),
