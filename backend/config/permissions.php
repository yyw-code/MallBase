    ...
    'base_menus' => [
        ...
        [
            ...
            'children' => [
                ...
                [
                    'name' => '分销管理',
                    'code' => 'SystemDistributionManagement',
                    'type' => 1,
                    ...
                    'affix_tab' => 0,
                    'no_basic_layout' => 0,
                    'remark' => '分销概览、分销员、佣金规则、佣金与提现管理',
                ],
            ],
        ],
        [
            'name' => '内容管理',
            'code' => 'SystemContentManagement',
            'type' => 1,
        ...
        [
            ...
            'no_basic_layout' => 0,
            'remark' => '文章新增/编辑页面',
            'parent' => 'SystemContentManagement',
        ],
        [
            'name' => '客户端装修',
            ...
            'children' => [
                ...
                [
                    'name' => '页面库',
                    'code' => 'SystemClientPageManagement',
                    'type' => 1,
                    'path' => '/client/page',
                    'icon' => 'lucide:files',
                    'component' => null,
                    'redirect' => '/client/page/list',
                    'sort' => 10,
                    'status' => 1,
                    'is_show' => 1,
                    'affix_tab' => 0,
                ...
                [
                    ...
                    'children' => [
                        ...
                        [
                            'name' => '悬浮按钮',
                            'code' => 'SystemClientDecorationFloating',
                            'type' => 1,
                            'path' => '/client/decorate/floating',
