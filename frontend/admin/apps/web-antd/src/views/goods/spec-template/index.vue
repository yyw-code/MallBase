...
<template>
  <div class="p-4">
    <div class="mb-3 flex items-center justify-between gap-4">
      <h2 class="m-0 text-lg font-semibold">规格模板</h2>
      <div class="flex flex-wrap justify-end gap-2">
        <a-button
          type="primary"
          @click="handleCreate"
          v-access:code="'SystemGoodsSpecTemplateCreate'"
        >
          新增模板
        </a-button>
    ...
    <div class="mb-3 rounded-lg border bg-[hsl(var(--card))] p-4">
      ...
      >
        <a-form-item label="模板名称" class="mb-0">
          <a-input
          ...
          <template v-if="column.key === 'action'">
            <a-space>
              <a-button
                ...
                v-access:code="'SystemGoodsSpecTemplateUpdate'"
              >
                编辑
              </a-button>
              <a-button
